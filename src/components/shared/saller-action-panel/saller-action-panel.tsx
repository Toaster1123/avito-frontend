...
export const SallerActionPanel: React.FC<Props> = ({ userName, price, registerDate, rating }) => {
  return (
    <div className="sticky top-5 h-fit max-[1380px]:max-w-[362px] mt-8 w-full max-w-[460px]">
      ...
      <div className="px-2">
        <SallerInfo registerDate={registerDate} userName={userName} rating={rating} />
        <div className="my-5">Отвечает около 30 минут</div>
        <SallerChat />
      </div>
    </div>
  );
